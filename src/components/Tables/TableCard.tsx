        ...
        <div className='relative flex flex-col items-start justify-evenly gap-[12px] w-[400px] h-full'>
            <div className='w-full h-[300px]'>
                <div className='relative overflow-hidden w-full h-full bg-transparent cursor-pointer rounded-[20px] border-[2px] border-solid border-cozey-beige'>
                    ...
                    {/* Floating chips */}
                    <div className='absolute bottom-[12px] right-[12px] flex justify-end items-center py-[6px] pr-[6px] pl-[10px] gap-[8px] bg-white rounded-[100px] cursor-pointer border-[0.5px] border-solid border-cozey-beige-dark'>
                    ...
                    {card.outdoor ? (
                        <div className='absolute inline-flex px-[12px] py-[8px] bg-cozey-brown rounded-[16px] max-w-fit top-[12px] left-[12px]'>
